...
import { chinatownPhotos } from '@/helpers/photos';
import type { ProjectId } from '../types';

export const id = 'uuid-33' as const satisfies ProjectId;

export const content = (
  <>
    <h1 className="text-2xl mb-4">The Chinese Quarter, District VIII</h1>
    <PhotoGalleryContent photos={chinatownPhotos.slice(0, 1)} columns={1} />
    <p>
    ...
    <PhotoGalleryContent photos={chinatownPhotos.slice(1, 10)} columns={2} />
  </>
);

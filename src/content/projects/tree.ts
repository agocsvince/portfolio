      ...
      children: [
        {
          ...
          id: 'uuid-28',
          children: [
            { title: 'gyuris_final.mkv', id: 'uuid-281' },
            { title: 'show_v3.mp4', id: 'uuid-282' },
          ],
        },
        { title: 'gyuris_x_szalai_szin.mov', id: 'uuid-22' },
        {
          ...
          id: 'uuid-25',
          children: [
            { title: 'nokia.mov', id: 'uuid-245' },
            { title: 'mi_vilagunk.mov', id: 'uuid-244' },
            {
              title: 'kereszt_dokumentumok',
              id: 'uuid-24',
              children: [
                { title: 'episode_1.mov', id: 'uuid-241' },
                { title: 'episode_2.mov', id: 'uuid-242' },
                { title: 'episode_3.mov', id: 'uuid-243' },
              ],
            },
            { title: 'palazzo_aftermovie.mp4', id: 'uuid-21' },
            {
              title: '2310_ep',
              id: 'uuid-23',
              children: [

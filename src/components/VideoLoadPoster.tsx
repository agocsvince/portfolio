...
const VideoLoadPoster = () => {
  return (
    <div className="w-full px-5 top-0 font-gothic absolute aspect-16/9 flex items-center justify-center bg-dark-primary/80 text-light-primary">
      <div className="relative flex flex-row border-2 sm:border-4 border-light-primary w-[85%] sm:w-[70%] text-center items-center justify-start">
        ...
        {Array.from({ length: 6 }).map((_, index) => (
          <div
          key={index}
          className="w-2 h-4 sm:w-4 sm:h-8 bg-light-primary animate-block-fade"
...
export default VideoLoadPoster